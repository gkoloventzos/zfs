...
extern int zfs_read(struct inode *ip, uio_t *uio, int ioflag, cred_t *cr , int *rot, const char *name);
...
extern int zfs_remove(struct inode *dip, char *name, cred_t *cr, int flags, boolean_t *up);
