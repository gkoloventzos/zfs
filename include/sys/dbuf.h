...
dmu_buf_impl_t *dbuf_hold(struct dnode *dn, uint64_t blkid, void *tag, int *rot, const char *name);
dmu_buf_impl_t *dbuf_hold_level(struct dnode *dn, int level, uint64_t blkid,
    void *tag, int *rot, const char *name);
...
void dbuf_prefetch(struct dnode *dn, int64_t level, uint64_t blkid,
    zio_priority_t prio, arc_flags_t aflags, int *rot, const char *name);
...
int dbuf_read(dmu_buf_impl_t *db, zio_t *zio, uint32_t flags, int *rot, const char *name);
