...
void dmu_buf_will_fill(dmu_buf_t *db, dmu_tx_t *tx, struct file *filp);
void dmu_buf_fill_done(dmu_buf_t *db, dmu_tx_t *tx, struct file *filp);
void dbuf_assign_arcbuf(dmu_buf_impl_t *db, arc_buf_t *buf, dmu_tx_t *tx, struct file *filp);
dbuf_dirty_record_t *dbuf_dirty(dmu_buf_impl_t *db, dmu_tx_t *tx, struct file *filp);
