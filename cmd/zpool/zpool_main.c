...
get_usage(zpool_help_t idx)
{
	...
	case HELP_STATUS:
		return (gettext("\tstatus [-c [script1,script2,...]] [-gLMPvxD]"
		    "[-T d|u] [pool] ... [interval [count]]\n"));
	case HELP_UPGRADE:
...
/*
 * zpool iostat [[-c [script1,script2,...]] [-lq]|[-rw]] [-ghHLMpPvy] [-n name]
...
/*
 * zpool status [-c [script1,script2,...]] [-gLMPvx] [-T d|u] [pool] ...
 *              [interval [count]]
 *
 *	-c CMD	For each vdev, run command CMD
 *	-g	Display guid for individual vdev name.
